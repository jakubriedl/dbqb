...
use Closure;
use JakubRiedl\Dbqb\ConnectionInterface;
...
class Builder
{
     ...
     *
     * @var \JakubRiedl\Dbqb\Connection
     */
     ...
     * @param  \JakubRiedl\Dbqb\Query\Grammars\Grammar $grammar
     * @param  \JakubRiedl\Dbqb\Query\Processors\Processor $processor
     * @return void
     */
     ...
     * @return \JakubRiedl\Dbqb\Query\Builder|static
     */
     ...
     *
     * @param  \Closure|\JakubRiedl\Dbqb\Query\Builder|string $query
     * @param  string $as
     * @return \JakubRiedl\Dbqb\Query\Builder|static
     */
     ...
     *
     * @param  \JakubRiedl\Dbqb\Query\Builder|static $query
     * @param  string $boolean
     * @return $this
     */
     ...
     *
     * @param  \JakubRiedl\Dbqb\Query\Builder|\Closure $query
     * @param  bool $all
     * @return \JakubRiedl\Dbqb\Query\Builder|static
     */
    ...
    public function lists($column, $key = null)
    {
        ...
        $values = $this->fetchColumn($results, $columns[0]);
        ...
        if (!is_null($key) && count($results) > 0) {
            $keys = $this->fetchColumn($results, $key);
    ...
    protected function fetchColumn($data, $column)
    {
        $results = [];
